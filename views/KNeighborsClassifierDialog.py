...
class Ui_KNeighborsClassifierDialog(object):
    def setupUi(self, KNeighborsClassifierDialog):
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.FieldRole, self.numNeighborsLineEdit)
        ...
        self.chooseClassAttributComboBox.addItem(_fromUtf8(""))
        self.formLayout.setWidget(2, QtGui.QFormLayout.FieldRole, self.chooseClassAttributComboBox)
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.chooseAlgorithmComboBox)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.leafSizeLineEdit)
